...
start_date="2018-01-02T00:00:00"
...
generate_config() {
    ...
    local output_path="/pscratch/sd/a/amahesh/s2s_8ckpt2ens/s2s_$formatted_date/"
...
while [[ "$current_date" < "$end_date" ]]; do
    ...
    current_date=$(date -u -d "$current_date + 7 days" "+%Y-%m-%d")
done
